...
# python main.py --model EDSR --scale 3 --patch_size 78 --save edsr_baseline_x3 --reset
...
python main.py --scale 3 --resume -1 --test_only --save_results --save_gt
cp -r ../experiment/test/results-Demo/ ./results
